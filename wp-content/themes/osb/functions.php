...
function bones_fonts() {
  wp_enqueue_style('googleFonts', '//fonts.googleapis.com/css?family=Montserrat:200,200i,300,300i,4000400i,500,500i,600,700|Kanit:200,200i,300,300i,400, 400i,500,500i,600,700');
}
...
add_action( 'wp_enqueue_scripts', 'remove_basic_css', 21 );

function remove_basic_css() {

  wp_dequeue_style( 'js_composer_front' );
  wp_dequeue_style( 'contact-form-7' );
  wp_dequeue_style( 'blogsynthesis_jss_css' );
...
function excerpt($limit) {
  ...
  if (count($excerpt)>=$limit) {
    array_pop($excerpt);
    $excerpt = implode(" ",$excerpt).'...<a class="home-news__news__text__more" href="'. get_permalink( get_the_ID() ) . '">' . __('Lire la suite', 'your-text-domain') . '</a>';
  } else {
